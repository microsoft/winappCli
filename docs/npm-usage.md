...
| `property` | `string \| string[] \| undefined` | No | Project mode: MSBuild property as Name=Value, forwarded to both build and evaluation. Repeat -p for multiple properties; use %3B or %2C for a literal semicolon or comma in a value. Ignored in folder mode. |
