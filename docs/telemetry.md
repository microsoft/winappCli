...
| Execution target | On command start and completion: `local`, `sandbox`, or `invalid`. Target names, addresses, and other user-provided identifiers are not collected. |
