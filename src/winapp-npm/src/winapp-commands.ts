...
export interface RunOptions extends CommonOptions {
  ...
  project?: string;
  /** Project mode: MSBuild property as Name=Value, forwarded to both build and evaluation. Repeatable. Ignored in folder mode. */
