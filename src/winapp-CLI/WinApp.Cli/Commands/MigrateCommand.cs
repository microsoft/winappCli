...
internal partial class MigrateCommand : Command, IShortDescription
{
    ...
    public MigrateCommand(
        ...
        : base("migrate", "Create a new WinUI 3 project from UWP source and apply deterministic mechanical transforms, including safely translatable activation declarations. Writes migration-report.json with known residual work. Success means the mechanical pass completed; it does not guarantee that the result builds or runs.")
    {
