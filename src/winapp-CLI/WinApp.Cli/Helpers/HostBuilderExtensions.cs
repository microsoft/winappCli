...
internal static class StoreHostBuilderExtensions
{
    public static IServiceCollection ConfigureServices(this IServiceCollection services)
    {
        return services
            ...
            .AddSingleton<IUiWorkflowContext, UiWorkflowContext>()
            ...
            .AddSingleton<IWindowResponseNative, WindowResponseNative>()
            ...
            .AddSingleton<IWptXamlToolResolver, WptXamlToolResolver>()
            .AddSingleton<IEtlLossInspector, WptEtlLossInspector>()
            .AddSingleton<IXamlPerformanceAnalyzer, XamlPerformanceAnalyzer>()
            .AddSingleton<IManagedProcessProbe, ManagedProcessProbe>()
            .AddSingleton<IManagedEventPipeClient, ManagedEventPipeClient>()
            ...
            .AddSingleton<IPerformanceScenarioLoader, PerformanceScenarioLoader>()
            .AddSingleton<IPerformanceRecordingSessionFactory, PerformanceRecordingSessionFactory>()
            .AddSingleton<IPerformanceUiCommandInvoker, PerformanceUiCommandInvoker>()
            .AddSingleton<IPerformanceScenarioDelay, PerformanceScenarioDelay>()
            .AddSingleton<IPerformanceScenarioRunner, PerformanceScenarioRunner>()
            .AddSingleton<IPerformanceSetWriter, PerformanceSetWriter>()
            .AddSingleton<IPerformanceSetComparer, PerformanceSetComparer>();
    }
    ...
    public static IServiceCollection ConfigureCommands(this IServiceCollection serviceCollection)
    {
        return serviceCollection
                ...
                .UseCommandHandler<PerfScenarioCommand, PerfScenarioCommand.Handler>()
                .UseCommandHandler<PerfCompareCommand, PerfCompareCommand.Handler>()
